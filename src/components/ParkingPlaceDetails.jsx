    ...
    <div className="w-full overflow-hidden space-y-6">
      {spot.available ? (
        <div className="flex items-center gap-4 px-4 py-2 bg-green-600">
          ...
          <p className="text-xl text-white rounded-sm">Avaliable</p>
        </div>
      ) : (
      ...
      <div className="grid sm:grid-cols-2 gap-10">
        <div className="">
          ...
          <p className="text-base text-gray-300">{spot.location}</p>
          <p className="mt-2 text-gray-400">{spot.description}</p>
        </div>
        <div className="flex flex-col gap-4 mt-10">
          <div className="flex items-center text-green-500">
            <FaDollarSign className="h-8 w-8" />
            <p className="text-4xl">{spot.pricePerHour}</p>
          </div>
