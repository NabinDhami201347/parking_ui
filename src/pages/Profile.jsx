        ...
        <div className="grid sm:grid-cols-3 gap-10">
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <div className="text-xl text-neutral-200">{user.vehicles.length}</div>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <div className="text-xl text-neutral-200">{user.reservations.length}</div>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <div className="text-xl text-neutral-200">{totalExpenses.toFixed(2)}</div>
            </div>
          </div>
        </div>
      )}
