  ...
  return (
    <div>
      ...
      <div className="min-h-[80vh] flex flex-col justify-center items-center">
        <div className="text-white text-4xl mb-6 animate-fade-in-up">Welcome to Parking Reservation</div>
        <p className="text-white text-lg mb-4 animate-fade-in-up-delay">
